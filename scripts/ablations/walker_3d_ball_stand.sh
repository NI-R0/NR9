...
python main.py --env_domain=walker_3D_ball --env_task=stand --run_name=w3d_stand_sgd16_c \
    --resume=runs/w3d_stand_sgd16/checkpoints/state.pkl \
...
python main.py --env_domain=walker_3D_ball --env_task=stand --run_name=w3d_stand_eps005_c \
    --resume=runs/w3d_stand_eps005/checkpoints/state.pkl \
    --episodes=2000 --eval_frequency=20 --num_envs=5 \
    --capacity=1000000 --warmup=5000 --lr=1e-4 --target_update_period=100 \
